...
export default class DeviceStore {
  ...
  async getTypes() {
    return await Axios.get('http://127.0.0.1:8000/api/type/').then((response => {
  ...
  async getDevices() {
    return await Axios.get('http://127.0.0.1:8000/api/device/').then((response => {
  ...
  async getBrands() {
    return await Axios.get('http://127.0.0.1:8000/api/brand/').then((response => {
